...
ScavTrap::ScavTrap(const std::string &string) : ClapTrap(string) {
...
unsigned
ScavTrap::challengeNewcomer(const std::string &target) {

    std::cout << this->_name << ": Activating Challenger.EXE" << std::endl;
